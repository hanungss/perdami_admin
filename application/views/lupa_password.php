...
<!--[if gt IE 9]><!--> <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <title>Lupa password | PERDAMI | Resertifikasi Dokter Spesialis Mata</title>
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-fixed page-header-inverse main-content-boxed">
                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="content-header content-header-fullrow px-15">
                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="<?php echo base_url() ?>index.php/login">
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                <li>
                                    <a href="<?php echo base_url() ?>index.php/login"><i class="si "></i><span class="sidebar-mini-hide">Login</span></a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url() ?>index.php/lupa_password/lupa_password"><i class="si "></i><span class="sidebar-mini-hide">Lupa password</span></a>
                                </li>
            ...
            <main id="main-container">
                ...
                <!-- Page Content -->
                <div class="content">
                    <h2 class="content-heading">Reset Password</h2>
                    ...
                    <div class="block">
                        ...
                        <div class="block-content">
                            <form action="<?php echo base_url();?>index.php/dashboard/ForgotPassword" method="post" onsubmit ='return validate();'">
                                <div class="col-md-6 form-group">
                                    <label for="example-nf-password">Masukkan Email anda</label>
                                    <input type="email" class="form-control" id="example-nf-password" name="email" placeholder="Masukkan email anda">
                                </div>
                               
                                <div class="col-md-6 form-group">
                                    <div>
                                        <button type="submit" value="submit" name="submit" class="btn btn-primary">Reset Password</button>
                                    </div>
                                </div>
                            </form>
                        </div>
