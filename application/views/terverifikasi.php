...
<!--[if gt IE 9]><!--> <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <title>Terverifikasi | PERDAMI | Resertifikasi Dokter Spesialis Mata</title>
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-fixed page-header-inverse main-content-boxed">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="active" href="terverifikasi"><i class="si si-check"></i><span class="sidebar-mini-hide">Terverifikasi</span></a>
                                </li>
                                <li>
            ...
            <main id="main-container">
                ...
                <div class="content">
                    <h2 class="content-heading">Data Pengajuan Telah Terverifikasi</h2>
                    <h6 class="content-body">Skore hanya dimiliki oleh Kelompok Pengajuan 2</h6>
                    <div class="block">
                        <div style="overflow-y:hidden; overflow-x:scroll; padding:0px; width:100%; height:auto; background-color: rgb(255, 255, 255); border:1px solid #ccc;">
                            <div class="block-content tab-content">
                                <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                    <thead>
                                        <tr>
                                            <!-- <th class="d-none d-sm-table-cell">Foto Profil</th> -->
                                            <th class="d-none d-sm-table-cell">No</th>
                                            <th style="width: 25%;">Nama Dokter</th>
                                            <th class="d-none d-sm-table-cell">Tanggal STR</th>
                                            <th class="d-none d-sm-table-cell">Cabang</th>
                                            <th class="d-none d-sm-table-cell">Instansi</th>
                                            <th class="d-none d-sm-table-cell">Kelompok</th>
                                            <th class="d-none d-sm-table-cell">Verifikator</th>
                                            <!-- <th class="d-none d-sm-table-cell">Skore</th> -->
                                            <th class="d-none d-sm-table-cell">Aksi</th>
                                            <th class="d-none d-sm-table-cell">Sertifikat</th>
                                            <th class="d-none d-sm-table-cell">Nomor sertifikat</th>
                                    ...
                                    <tbody>
                                     ...
                                     if(!empty($cek_terverifikasi)){
                                        ...
                                        foreach ($cek_terverifikasi as $row){ ?>
                                            <tr>
                                                <td class="font-w600"><?php echo $no;?></td>
                                                <td class="font-w600"><?php echo $row->nama_user; ?></td>
                                                <td class="d-none d-sm-table-cell"><?php echo $row->str; ?></td>
                                                <td class="d-none d-sm-table-cell"><?php echo $row->cabang; ?></td>
                                                <td class="d-none d-sm-table-cell"><?php echo $row->instansi; ?></td>
                                                <td class="d-none d-sm-table-cell">Kelompok <?php echo $row->kelompok; ?></td>
                                                <td class="d-none d-sm-table-cell"><?php echo $row->verifikator; ?></td>
                                                <!-- <td class="d-none d-sm-table-cell">
                                                    <?php
                                                    $this->db->select('SUM(skore) as total');
                                                    $this->db->from('file');
                                                    $this->db->where('id_file',$row->id_status);
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <div>
                                                        <?php echo '<a href="'.base_url().'index.php/dashboard/detail_pengajuan/'.$row->id_status.'"class="btn btn-sm btn btn-primary" title="Detail" class="fa fa-times">Tinjau</a>'?>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <div>
                                                        <!-- <small>coming soon</small> -->
                                                        <?php echo '<a href="'.base_url().'index.php/dashboard/sertifikat/'.$row->id_status.'"class="btn btn-sm btn btn-secondary" title="Detail" class="fa fa-times">Lihat</a>'?>
                                                    </div>
                                                </td>
                                                <td class="d-none d-sm-table-cell">01012019<?php echo $row->id_status; ?></td> 
                                               <!--  <td class="text-center">

                                                    <div>
                                                        <?php echo '<a href="'.base_url().'index.php/dashboard/detail_verifikasi/'.$row->id_user.'"class="btn btn-sm btn btn-primary" title="Hapus" class="fa fa-times">Detail</a>'?>
                                                    </div>
                                                </td>  -->
