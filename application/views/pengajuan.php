                                                ...
                                                <li>
                                                    <a class="text-body-color-dark media mb-15" href="javascript:void(0)">
                                                        <div class="ml-5 mr-15">
                                                            ...
                                                            <b class="mb-0">Kelengkapan File</b>
                                                            <p class="mb-0"><?php echo $row->kelengkapan; ?></p>   
                                                            <div class="text-muted font-size-sm font-italic"><?php echo $row->tanggal; ?></div>
                                                        </div>
                                                    </a>
                                                </li>
                                    ...
                                    <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="d-none d-sm-table-cell">Verifikator sebelumnya</th>
                                                <!-- <th class="d-none d-sm-table-cell">Skore</th> -->
                                                <th class="text-center" style="width: 15%;">Verifikasi</th>
                                                <th class="text-center" style="width: 15%;">Hapus Pengajuan</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                           <?php
                                           if(!empty($cek_all_pengajuan)){
                                            ...
                                            foreach ($cek_all_pengajuan as $row){ ?>
                                                <tr>
                                                    <td class="d-none d-sm-table-cell"><?php echo $no; ?></td>
                                                   ...
                                                   <!--  <td class="d-none d-sm-table-cell"></td> -->
                                                    <td class="text-center">
                                                        <div>
                                                            <?php echo '<a href="'.base_url().'index.php/dashboard/detail_pengajuan/'.$row->id_status.'"class="btn btn-sm btn btn-primary" title="Detail" class="fa fa-times">Verifikasi</a>'?>
                                                        </div>            
                                                    </td>
                                                    <td class="text-center">
                                                        <div>
                                                            <?php echo '<a href="'.base_url().'index.php/dashboard/hapus_pengajuan/'.$row->id_row.'"class="btn btn-sm btn btn-secondary" title="Delete" class="fa fa-times" " onclick="return confirm(\'Anda yakin akan menghapusnya?\')">Hapus</a>'?>
                                                        </div>
                                                    </td> 
