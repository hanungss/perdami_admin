        ...
        <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-fixed page-header-inverse main-content-boxed">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="active" href="admin"><i class="si si-key"></i><span class="sidebar-mini-hide">Admin</span></a>
                                </li>
                                <li>
            ...
            <main id="main-container">
                ...
                <div class="content">
                                        ...
                                        <div class="block-content block-content-full clearfix">
                                            <div class="text-left">
                                                <ul class="nav-users">
                                                    ...
                                                    <li>
                                                        <p><label class="label-horizontal">Nama : </label><?php echo $row->nama_admin; ?></p>
                                                    </li>
                                                    <li>
                                                        <p><label class="label-horizontal">ID Admin : </label><?php echo $row->id_admin; ?></p>
                                                    </li>
                                                    <li>
                                                        <p><label class="label-horizontal">Username admin : </label><?php echo $row->username; ?></p>
                                                    </li>
                                                    <li>
                                                        <p><label class="label-horizontal">Email : </label><?php echo $row->email; ?></p>
                                                    </li>
                                                    <li>
                                                        <p><label class="label-horizontal">Level Admin : </label><?php echo $row->jenis_admin; ?></p>
                                                    </li>
                                                </ul>
                                            <?php } ?>
                                            </div>
                    ...
                    <h2 class="content-heading">Data Admin Perdami</h2>
                     <div class="block">
                                        ...
                                        <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="d-none d-sm-table-cell">ID User</th>
                                                    <th class="text-center" style="width: 15%;">Hapus Admin</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                 <?php
                                                    if(!empty($cek_admin)){
                                                        ...
                                                        foreach ($cek_admin as $row){ ?>
                                                            <tr>
                                                                ...
                                                                <td class="font-w600"><?php echo $row->nama_admin; ?></td>
                                                                <td class="d-none d-sm-table-cell"><?php echo $row->username; ?></td>
                                                                <td class="d-none d-sm-table-cell"><?php echo $row->id_admin; ?></td>
                                                                <td class="text-center">
                                                                    <div>
                                                                       <?php 
                                                                       if ($this->session->userdata("user_jenis") != '1'){
                                                                        echo "Fitur super admin";
                                                                    }else{

                                                                        echo '<a href="'.base_url().'index.php/dashboard/remove_admin/'.$row->id_admin.'"class="btn btn-sm btn-danger" title="Hapus" class="fa fa-times" " onclick="return confirm(\'Anda yakin akan menghapusnya?\')">Delete</a>';
                                                        ...
                                                        <?php 
                                                    if ($this->session->userdata("user_jenis") != '1'){
                                                        echo "Berikut ini daftar admin yang terdaftar";
                                                    }else{
                                                        
                                                        echo '<a href="'.base_url().'index.php/dashboard/tambah_admin"class="btn btn-sm btn-hero btn-primary mt-20" title="Tambah admin" class="fa fa-times">Tambah Admin</a>';
                                                        
                                                    } ?> 
                                                  <!--   <a class="btn btn-sm btn-hero btn-primary mt-20" href="tambah_admin">Tambah Admin</a> -->
