...
<!--[if gt IE 9]><!--> <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <title>Pengajuan | PERDAMI | Resertifikasi Dokter Spesialis Mata</title>
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-fixed page-header-inverse main-content-boxed">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="active" href="pengajuan"><i class="si si-book-open"></i><span class="sidebar-mini-hide">Pengajuan</span></a>
                                </li>
                                <li>
            ...
            <main id="main-container">
                ...
                <!-- Page Content -->
                 <div class="content">
                        <h2 class="content-heading">Data Pengajuan Dokter</h2>
                        <div class="block">
                            ...
                            <table cellpadding="8">    
                                <tr>      
                                    ...
                                    <td>        
                                        <select name="id_file" id="id_file" style="width: 200px;">          
                                            <option value="">Pilih</option>                    
                                            <?php foreach($cek_all_user as $row){
                                ...
                                <tr>      
                                    ...
                                    <td>        
                                        <select name="kelompok" id="kelompok" style="width: 200px;">         
                                            <option value="">Pilih</option>
                                    ...
                                    <td>        
                                        <select name="kelompok" id="kelompok" style="width: 200px;">         
                                            <div id="loading" style="margin-top: 15px;">          
                                                <img src="images/loading.gif" width="18"> 
                                                <small>Loading...</small>        
                                            </div>        
                                        </select>              
                                    </td>    
                                ...
                                <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="d-none d-sm-table-cell">Tanggal Pengajuan</th>
                                            ...
                                            <th class="d-none d-sm-table-cell">Status Pengajuan</th>
                                    ...
                                    <tbody>
                                       <?php
                                       if(!empty($cek_all_pengajuan))
                                        foreach ($cek_all_pengajuan as $row){ ?>
                                            <tr>
                                                ...
                                                <td class="d-none d-sm-table-cell"><?php echo $row->kelompok; ?></td>
                                                <td class="d-none d-sm-table-cell"><?php echo $row->status; ?></td>
                                                <td class="d-none d-sm-table-cell"><?php echo $row->skore; ?></td>
                                                <td class="text-center">

                                                    <div>
                                                        <?php echo '<a href="'.base_url().'index.php/dashboard/remove_user/'.$row->id_user.'"class="btn btn-sm btn-danger" title="Hapus" class="fa fa-times" " onclick="return confirm(\'Anda yakin akan menghapusnya?\')">Delete</a>'?>
                                                    </div>
                                                     <?php echo '<a href="'.base_url().'index.php/dashboard/pengajuan/'.$row->id_user.'"class="btn btn-sm btn-group" title="Detail" class="fa fa-times" )">Cek Status</a>'?>
                                                </td> 
        ...
        <!-- Javascript -->
              ...
              <script>  $(document).ready(function(){ // Ketika halaman sudah siap (sudah selesai di load)    // Kita sembunyikan dulu untuk loadingnya    
                $("#loading").hide();        
                $("#id_file").change(function(){ // Ketika user mengganti atau memilih data provinsi      
                    $("#kota").hide(); // Sembunyikan dulu combobox kota nya      
                    $("#loading").show(); // Tampilkan loadingnya          
                    $.ajax({ type: "POST", // Method pengiriman data bisa dengan GET atau POST        
                    url: "", // Isi dengan url/path file php yang dituju        
                    data: {id_provinsi : $("#provinsi").val()}, // data yang akan dikirim ke file yang dituju        
                    dataType: "json", beforeSend: function(e) { if(e && e.overrideMimeType) {e.overrideMimeType("application/json;charset=UTF-8");}},
