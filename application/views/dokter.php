...
<head>
    ...
    <title>Daftar Dokter | PERDAMI | Resertifikasi Dokter Spesialis Mata</title>
    ...
    <script>
        $(function(){
            $(document).on('click','.detail',function(e){
                ...
                $.post("<?php echo site_url()?>dashboard/pengajuan",
                    {id:$(this).attr('data-id')},
                    function(html){
                        $(".hal_pengajuan").html(html);
                    }   
                    );
            });
        });
            ...
            <!--
                        ...
                        <div class="sidebar-content">
                            ...
                            <div class="content-side content-side-full">
                                <ul class="nav-main">
                                    ...
                                    <li>
                                        <a class="active" href="dokter"><i class="fa fa-stethoscope"></i><span class="sidebar-mini-hide">Dokter</span></a>
                                    </li>
                                    <li>
                ...
                <header id="page-header">
                    ...
                    <main id="main-container">
                        ...
                        <!-- Page Content -->
                        <div class="content">
                            <h2 class="content-heading">Data Dokter Perdami</h2>
                            <div class="block">
                                    ...
                                    <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="d-none d-sm-table-cell">No Anggota</th>
                                                ...
                                                <th class="d-none d-sm-table-cell">Hapus Akun</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                         <?php
                                         if(!empty($cek_all_user)){
                                            $no = 1;
                                            foreach ($cek_all_user as $row){ ?>
                                                <tr>
                                                ...
                                                <td class="d-none d-sm-table-cell"><?php echo $row->no_anggota; ?></td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <div>
                                                        <?php echo '<a href="'.base_url().'index.php/dashboard/detail_dokter/'.$row->id_user.'"class="btn btn-sm btn btn-primary" title="Rincian Profil" class="fa fa-times">Detail</a>'?>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <?php 
                                                    if ($this->session->userdata("user_jenis") != '1'){
                                                        echo "khusus super admin";
                                                    }else{

                                                        echo '<a href="'.base_url().'index.php/dashboard/remove_dokter/'.$row->id_user.'"class="btn btn-sm btn btn-danger" title="Hapus user" class="fa fa-times" onclick="return confirm(\'Anda yakin akan menghapusnya?\')">Delete</a>';
