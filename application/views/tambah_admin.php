...
<!--[if gt IE 9]><!--> <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <title>Tambah Admin Baru | PERDAMI | Resertifikasi Dokter Spesialis Mata</title>
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-fixed page-header-inverse main-content-boxed">
            ...
            <main id="main-container">
                ...
                <!-- Page Content -->
                <div class="content">
                    <h2 class="content-heading">Daftar Admin Baru</h2>
                    ...
                    <div class="block">
                        ...
                        <div class="block-content">
                            ...
                            <div class="px-30 py-10">
                                    ...
                                    <h1 class="h3 font-w700 mt-30 mb-10">Daftar admin baru</h1>
                                ...
                                <!-- <form class="js-validation-signup px-30" action="profil" method="post"> -->
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material floating">
                                                <input type="text" class="form-control" id="signup-nama-admin" name="nama_admin" value="<?=set_value('nama_admin')?>" required>
                                                <label for="signup-no">Nama admin</label>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material floating">
                                                <select class="form-control" id="material-select2" name="jenis_admin">
                                                    <option value="1">Super Admin</option>
                                                    <option value="2">Admin Biasa</option>
                                                </select>
                                                <label for="material-select2">Jenis Admin</label>
                                                <small class="text-danger"><?=form_error('jenis_admin')?></small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="submit" value="upload" name="submit" class="js-swal-success btn btn-success" ><i class="fa fa-plus mr-10"></i> Tambah</button>
                                    </div>
                                </form>
                               <?php echo form_close();?> 
                                <!-- END Sign Up Form -->
