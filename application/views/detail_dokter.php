    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-fixed page-header-inverse main-content-boxed">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="active" href="<?php echo base_url() ?>index.php/dashboard/dokter"><i class="fa fa-stethoscope"></i><span class="sidebar-mini-hide">Dokter</span></a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url() ?>index.php/dashboard/pengajuan"><i class="si si-book-open"></i><span class="sidebar-mini-hide">Pengajuan</span></a>
                                </li>
                                <li>
            ...
            <main id="main-container">
                ...
                <!-- Page Content -->
                <div class="content">
                    <h2 class="content-heading">Detail Profil Yang Anda Pilih</h2>
                    <div class="block">
                                    ...
                                    <div class="float-left">
                                        ...
                                        if(!empty($dokter))
                                            foreach ($dokter as $row){ ?>
                                                <img class="img-responsive mt-20" src="http://resertifikasi.perdami.id/Upload/foto/<?php echo $row->foto; ?>" alt="Foto" style="height: 270px;object-fit: cover;">
                                            <?php } else { ?>
                                        ...
                                        <div class="block-content block-content-full clearfix">
                                            <div class="text-left">
                                                <ul class="nav-users">
                                                    ...
                                                    <li>
                                                        <p><label class="label-horizontal">Nama Dokter: </label><?php echo $row->nama_user; ?></p>
                                                    </li>
                                                    <li>
                                                        <p><label class="label-horizontal">No Anggota PERDAMI : </label><?php echo $row->no_anggota; ?></p>
                                                    </li>
                                                    <li>
                                                        <p><label class="label-horizontal">NPA IDI : </label><?php echo $row->no_idi; ?></p>
                                                    </li>
                                                    <li>
                                                        <p><label class="label-horizontal">Tempat dan tanggal lahir : </label><?php echo $row->tempat_lahir; ?></p>
                                                    </li>
                                                    <li>
                                                        <p><label class="label-horizontal">Universitas pendidikan dokter spesialis : </label><?php echo $row->universitas; ?></p>
                                                    </li>
                                                    <li>
                                                        <p><label class="label-horizontal">Username  : </label><?php echo $row->username; ?></p>
                                                    </li>
                                                    <li>
                                                        <p><label class="label-horizontal">Email : </label><?php echo $row->email; ?></p>
                                                    </li>
                                                    <li>
                                                        <p><label class="label-horizontal">Cabang : </label><?php echo $row->cabang; ?></p>
                                                    </li>
                                                </ul>
                                            <?php } ?>
                                            </div>
                    ...
                    <h2 class="content-heading">Data file yang di unggah</h2>
                     <div class="block">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="d-none d-sm-table-cell">Ukuran File</th>
                                                     <th class="d-none d-sm-table-cell">Kelompok Pengajuan</th>
                                                        ...
                                                        foreach ($file as $row){ ?>
                                                            <tr>
                                                                ...
                                                                <!-- <td class="text-center">
                                                                    <div>
                                                                        <?php echo '<a href="'.base_url().'index.php/dashboard/download/'.$row->id_row.'"class="btn btn-sm btn-secondary" title="Download File" class="fa fa-times">Unduh</a>'?>
                                                                    </div>
                                                                </td> -->
                                                            </tr>
                                                        <?php } else { ?>
